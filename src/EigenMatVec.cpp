...
// [[Rcpp::export]]
Rcpp::List RcppHamiltonian(Map<VectorXd> position, Map<VectorXd> momentum, double time) {
...
// [[Rcpp::export]]
VectorXd RcppBounceMomentum(Map<VectorXd> position,
                            Map<VectorXd> momentum,
                            Map<MatrixXd> constraint_direc,
                            Map<MatrixXd> constraint_row_normsq,
                            int bounce_idx) {
...
// [[Rcpp::export]]
Rcpp::List RcppBounceTime(Map<VectorXd> position,
                          Map<VectorXd> momentum,
                          Map<MatrixXd> constraint_direc,
                          Map<VectorXd> constraint_bound) {
