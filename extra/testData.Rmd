...
(d=50)nEXACT, nTN, nHZZ, nNUTS: 500, 500, 1000, 1000
(d=100)nEXACT, nTN, nHZZ, nNUTS: 800, 500, 1000, 1000
...
n1(d=1600)nEXACT, nTN, nHZZ, nNUTS: 
n100(d=1600)nEXACT, nTN, nHZZ, nNUTS: 

```{r from LKJ prior}
dimension <- 1600 # TN limit is about 300 (endless low acceptance rate)
set.seed(666)
