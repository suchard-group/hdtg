...
samples_rcpp = rcmg(n = 10, mean = mu, prec = prec, constraits = rep(1, d), t = 10, burnin = 0, p0 = p0, cpp_flg = T, debug_flg = F)
t1 = proc.time()
...
# t0 = proc.time()
# 
# samples_r = rcmg(n = 10, mean = mu, prec = prec, constraits = rep(1, d), t = 10, burnin = 0, p0 = p0, cpp_flg = F, debug_flg = F)
# 
# t1 = proc.time()
